...
namespace Hotel_Manager
{
    public partial class FinalizePayment : MetroForm
    {
        ...
        private void FinalizePayment_Load(object sender, EventArgs e)
        {
            ...
            currentBillAmount.Text = "$" + Convert.ToString(totalAmountFromFrontend)+" USD";                // current bill is room charge
            foodBillAmount.Text = "$" + Convert.ToString(foodBill) + " USD";                                // food charge
