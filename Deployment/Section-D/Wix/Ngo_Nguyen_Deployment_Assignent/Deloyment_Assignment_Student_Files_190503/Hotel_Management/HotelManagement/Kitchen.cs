...
namespace Hotel_Manager
{
    public partial class Kitchen : MetroForm
    {
        ...
        SqlConnection connection = new SqlConnection(@"Data Source = (LocalDB)\MSSQLLocalDB; AttachDbFilename = F:\Hotel_Management_(additional) - Copy\HotelManagement\frontend_reservation.mdf");
        SqlCommand query;
