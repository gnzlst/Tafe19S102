...
namespace Hotel_Manager
{
    public partial class Frontend : MetroForm
    {
        ...
        private void finalizeButton_Click(object sender, EventArgs e)
        {
            ...
            finalizebil.totalAmountFromFrontend = totalAmount;          // totalAmountFromFrontEnd = room charge * no. of days
        ...
        private void phoneNumberTextBox_Leave(object sender, EventArgs e)
        {
            /*
                            ...
                            long getphn = Convert.ToInt64(phoneNumberTextBox.Text);   // Add try catch statement and log.fatal() here!
                            string formatString = String.Format("{0:(###) ###-####}", getphn);
            ...
            phoneNumberTextBox.Text = regexObj.Replace(phoneNumberTextBox.Text, "");

            // Second, format numbers to phone string 
            if (phoneNumberTextBox.Text.Length > 0)
            {
                phoneNumberTextBox.Text = Convert.ToInt64(phoneNumberTextBox.Text).ToString(phoneFormat);
            }
